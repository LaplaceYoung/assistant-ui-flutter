...
| `attachment` | A remote backend (the port ships in-memory and file-backed ones) | Upstream leaves uploads to the app through `AttachmentAdapter`; the port ships the same contract, progress, preview and remove |
